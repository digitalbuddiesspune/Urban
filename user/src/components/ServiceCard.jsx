  ...
  return (
    <Link to={`/services/${service._id}`} className="card group overflow-hidden transition hover:shadow-lg">
      ...
      <div className="p-3 sm:p-4">
        ...
        <h3 className="mt-0.5 line-clamp-2 text-sm font-semibold leading-snug text-slate-800 sm:mt-1 sm:line-clamp-1 sm:text-base">{service.title}</h3>
        ...
        <div className="mt-2 flex items-center justify-between gap-1 sm:mt-3">
          ...
          <span className="shrink-0 rounded-lg bg-violet-50 px-2 py-0.5 text-[10px] font-semibold text-violet-700 sm:px-3 sm:py-1 sm:text-xs">Book</span>
        </div>
      </div>
    </Link>
  )
